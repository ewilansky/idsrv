...
namespace ClientHybridWithPkce
{
    class Program
    {
        private const string Api = "https://mini.local:44304/api";
        private const string Authority = "https://mac.local:44304";
        static OidcClient _oidcClient;
        static HttpClient _apiClient = new HttpClient
        {
            BaseAddress = new Uri(Api + "/webHdfs")
        };
        ...
        private static async Task SignIn()
        {
            ...
            string redirectUri = "https://mac.local:44399";
